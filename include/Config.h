...
const float confineMargin = 0.5f;
...
const float ballLocalizerForwardNoise = 0.5f;
const float ballLocalizerTurnNoise = 0.3f;
const float ballLocalizerSenseNoise = 0.2f;
...
const float fluidOmegaStep = 6.28f;
...
const float goalFocusP = 3.5f;						//< how fast to yaw to focus on a goal (angle multiplier)
...
const float spinAroundDribblerRadius = 0.1f;		//< radius at which to spin around the dribbler
const float spinAroundDribblerForwardSpeed = 0.2f;	//< radius at which to spin around the dribbler
