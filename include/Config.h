...
const float spinAroundDribblerRadius = 0.2f;		//< radius at which to spin around the dribbler
const float spinAroundDribblerForwardSpeed = 0.35f;	//< radius at which to spin around the dribbler
